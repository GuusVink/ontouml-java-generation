/*******************************************************************************
 * File generated from the ontology::aguiar2018rdbso::model::ontology::rdbso::Constraint uml Class
 ...
 * @author 
 */
public class Constraint implements RDBMSItem {
	// Start of user code (user defined attributes for Constraint)
	 ...
	 */
	public Constraint() {
		// Start of user code constructor for Constraint)
		super();
		// End of user code
	}
	
	// Start of user code (user defined methods for Constraint)
