/*******************************************************************************
 * File generated from the ontology::aguiar2018rdbso::model::ontology::dbso::DBMSAccount uml Class
...
/**
 * Description of DBMSAccount.
 * 
 * @author 
 */
public class DBMSAccount implements DBMSItem {
	/**
	 * Description of the property dictionary.
	 */
	public Dictionary dictionary = null;
	
	// Start of user code (user defined attributes for DBMSAccount)
	 ...
	 */
	public DBMSAccount() {
		// Start of user code constructor for DBMSAccount)
		super();
		// End of user code
	}
	
	// Start of user code (user defined methods for DBMSAccount)
