...
public class UML2JavaConfigurationHolder extends AdapterImpl {
	...
	public static UML2JavaConfigurationHolder SINGLETON_INSTANCE = null;
	...
	/**
	 * Previously retrieved for a specific model element. Now work with a global set configuration being applied for all models.
	 * @author Guus
	 * 
	 * @param eObject
	 *            The model element
	...
	private static UML2JavaConfigurationHolder getConfigurationHolder(EObject eObject) {
		return UML2JavaConfigurationHolder.SINGLETON_INSTANCE;
	}
